...
const information_label_inputs = document.querySelectorAll('.label__first-dialog');
const information_input_users = document.querySelectorAll('.first-dialog__input')
